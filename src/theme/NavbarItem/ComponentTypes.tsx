import { BlogNavbarItem } from '@site/src/components/BlogLink';
...
/**
 * Registers the three navbar items written here. This is the only supported way
...
export default {
  ...ComponentTypes,
  'custom-blogLink': BlogNavbarItem,
